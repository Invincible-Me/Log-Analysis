...
Answer_2 = """select authors.name,sum(article_view.views) as views from article_view,
           authors where authors.id = article_view.author group by
...
Edit Snippet
 Wordwrap
import psycopg2
# What is this for? It is not being used anywhere? 
import bleach
​
dbname = "news"
​
